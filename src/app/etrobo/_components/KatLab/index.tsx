...
export const KatLab = () => {
  const ACHIEVE = {
    list: [
      ...
      "2023/10 : ETロボコン地区(九州)大会2023 アドバンストクラス 総合優勝",
    ...
    <section>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.text}>
          ...
          <p>
            KatLabでの私の役割は、2022年大会では主に実装を担当し、2023年大会では設計と実装を担当していました。また、2023年大会ではチームリーダーとして、チームマネジメントやタスク全体の管理、運営や他チームとの交流などの役割も担っていました。2024年大会では、主に設計を担当していました。
          </p>
        </div>
      </div>
      <List {...ACHIEVE} />
